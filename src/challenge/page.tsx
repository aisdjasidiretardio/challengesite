...
const SYMBOL_META: Record<VaultSymbol, SymbolDetails> = {
  ...
  coin: {
    name: "Coin",
    short: "COIN",
    symbol: asset("coin.png"),
    clue: asset("merchant.png"),
  ...
  key: {
    name: "Key",
    short: "KEY",
    symbol: asset("key.png"),
    clue: asset("knight.png"),
  ...
  sword: {
    name: "Sword",
    short: "SWORD",
    symbol: asset("sword.png"),
    clue: asset("guard.png"),
